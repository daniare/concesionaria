...
public class CocheResource {
     ...
     */
    @GetMapping("/coches")
    public ResponseEntity<List<Coche>> getAllCoches(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of coches in body.
     */
    @GetMapping("/coches/coches-by-color/{color}")
    public ResponseEntity<List<Coche>> getAllCoches(@PathVariable String color) {
    ...
    /**
     * {@code GET  /coches/coches-by-modelo} : get all the coches by color.
     *
     * @param pageable the pagination information.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of coches in body.
     */
